...
This is an example file for working with databases. Go provides an abstract datalayer using the [`database/sql`](https://golang.org/pkg/database/sql/) standard library. You need to load the specific driver your database first, than working with it is relatively the same.

This example uses the [`go-sql-driver/mysql`](https://github.com/go-sql-driver/mysql).
